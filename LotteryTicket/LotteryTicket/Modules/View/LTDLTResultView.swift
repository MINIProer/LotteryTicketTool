...
class LTDLTResultView: UIView {
    ...
    func configDefault() {
        ...
        self.backgroundColor = UIColor.init(hexStr: "#FFA4F6").withAlphaComponent(0.4)
    }
    ...
    func setupUI() {
        ...
        bLabel1.snp.makeConstraints { make in
            make.centerY.equalTo(self)
            make.leading.equalTo(rLabel5.snp.trailing).offset(20)
            make.size.equalTo(CGSize(width: 30, height: 30))
        }
        
        self.addSubview(bLabel2)
    ...
    func refreshUI(withData data: LTResultDataItemModel) {
        ...
        bLabel2.text = (blueBallsArray[1] as LTBallItemModel).value_string
    }
